...
function pantallaInicio() {
  ...
  dibujarBoton(width/2 - 125, height/2 - 20, 150, 40, "INICIAR");
  dibujarBoton(width/2 - 125, height/2 + 40, 150, 40, "CRÉDITOS");
}
...
function pantallaCreditos() {
  ...
  dibujarBoton(width/2 - 125, height - 80, 150, 40, "Volver al inicio");
}
...
function dibujarOpciones() {
  // Aquí se llama a la función que usa la constante OPCIONES_TEXTO
  let textos = obtenerTextosOpciones(escena); 
  dibujarBoton(width/2 - 125, 300, BUTTON_W, BUTTON_H, textos.A);
  dibujarBoton(width/2 - 125, 360, BUTTON_W, BUTTON_H, textos.B);
}
...
function hayBotonHover() {
  ...
  if (escena === -1) {
    return mouseDentro(width/2 - 125, height/2 - 20, 150, 40) || mouseDentro(width/2 - 125, height/2 + 40, 150, 40);
  } else if (escena === 99 || (escena >= 100 && escena <= 102)) {
    return mouseDentro(width/2 - 125, height - 80, 150, 40);
  }
  else if (escena >= 0 && escena < totalImages) {
    if (esBifurcacion(escena)) {
      return mouseDentro(width/2 - 125, 300, 150, 40) || mouseDentro(width/2 - 125, 360, 150, 40);
