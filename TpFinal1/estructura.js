...
// 2. FUNCIÓN: Busca en la constante el texto de las opciones
function obtenerTextosOpciones(n) {
  // Busca la clave 'n' en el mapa. Si no la encuentra, usa el fallback.
  return OPCIONES_TEXTO[n] || { A: "Opción A", B: "Opción B" };
}

// Función para obtener los textos (usa el mapa, no switch)
function obtenerTextosOpciones(n) {
  return OPCIONES_TEXTO[n] || { A: "Opción A", B: "Opción B" };
}
